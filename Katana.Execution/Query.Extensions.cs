...
namespace Katana.Execution
{
    public static class QueryExtensions
    {
        ...
        public static int CreateTable(this Query query, string name, IEnumerable<AbstractCreateClause.Column> columns, IDbTransaction transaction = null, int? timeout = null)
        {
            return CreateQueryFactory(query).Execute(query.Create(name, columns), transaction, timeout);
        }
